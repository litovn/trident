...
class PolicyGate:
    ...
    def check(self, action: Action) -> Decision:
        ...
        # 4) Host allowlist (only checked if endpoint param present).
        ...
        # 5) HITL — v0 stub: deny; v1 will prompt
